...
namespace tgsdesktop.utilities {
    public class RijndaelEnhanced {
        ...
        public RijndaelEnhanced(string passPhrase,
            ...
            // the passPhrase and initialization vector is stored in the application resources
            if (string.IsNullOrEmpty(passPhrase))
                passPhrase = utilities.ResourceAccessor.GetStringResource("Passphrase");
            if (string.IsNullOrEmpty(initVector))
                initVector = utilities.ResourceAccessor.GetStringResource("IV");
